<div align="center">
  <img src="docs/res/img/misc/logo.png" width="300" height="300">
  <h1>minimalLog</h1>
  <p>A minimal and easy-to-use log library for java </p>
  <br>
  <img src="docs/res/img/link-buttons/download.png" width="125px">
  <img src="docs/res/img/link-buttons/changelog.png" width="125px">
  <img src="docs/res/img/link-buttons/support.png" width="125px">
  <img src="docs/res/img/link-buttons/contribute.png" width="125px">
</div>
...
Also there should always be a _helpful_ documentation of each function or whatever you can get problems with. If there's not please create an [issue](https://github.com/Drainyyyy/minimalLog/issues).
...
Because of having not that much features minimalLog is more for something like applications that don't need that much console logs.
But to be honest you can also use it in big projects, but there are few options out there that are definitely better than minimalLog in this case. But it's your choice!
...
![cLog1](docs/res/img/examples/cLog1.png)

--- 4. ---

![cLog2](docs/res/img/examples/cLog2.png)

--- 5. ---

![cLog3](docs/res/img/examples/cLog3.png)

--- 6. ---

![cLog4](docs/res/img/examples/cLog4.png)

--- 7. ---

![cLogErr1](docs/res/img/examples/cLogErr1.png)

--- 8. ---

![cLogErr2](docs/res/img/examples/cLogErr2.png)
